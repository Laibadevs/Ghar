    ...
    <section className="px-20 py-20 ">
      <div className="flex items-start gap-40">
        ...
        <div className="flex flex-col gap-7 max-w-[800px]">
          ...
          <motion.h1
            {...stagger(0.1)}
            className="font-serif text-[3rem] font-normal text-black leading-[1.1] tracking-tight"
          >
          ...
          <motion.p
            {...stagger(0.2)}
            className="text-[0.95rem] text-gray-500 leading-relaxed"
          >
            Tap{" "}
            <strong className="text-black font-semibold">
              "Share with Parents"
            </strong>{" "}
            on any listing and Ghar generates a clean, one-tap summary — price,
            distance, facilities, a safety score and landlord verification —
        ...
        <motion.div
          {...stagger(0.25)}
          className="w-[630px] rounded-[42px] overflow-hidden border border-[#D7F3EB] shadow-[0_20px_60px_rgba(0,0,0,0.08)] bg-white"
        >
          {/* WhatsApp header — Ammi */}
          <div className="bg-[#2B7B67] flex items-center justify-between px-4 py-5">
            <div className="flex items-center gap-3">
              <div className="w-16 h-16 rounded-full bg-[#1F6F5F] flex items-center justify-center text-white font-bold text-xl">
                A
              </div>
              <div>
                <div className="text-white font-semibold text-2xl">Ammi</div>
          ...
          <div className="bg-2FA084 px-12 py-12 flex flex-col gap-5">
            {/* Card title */}
            <div>
              ...
              <div className="flex items-center gap-1.5 text-[0.8rem] text-gray-500">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path
                    d="M7 1C4.24 1 2 3.24 2 6c0 3.75 5 7 5 7s5-3.25 5-7c0-2.76-2.24-5-5-5z"
                    stroke="#2FA084"
                    strokeWidth="1.3"
                  />
                  <circle
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={label}
                  className="bg-white rounded-xl px-4 py-3 flex flex-col gap-1 border border-gray-100"
                >
                  <div className="flex items-center gap-1.5 text-[0.72rem] text-gray-400 font-medium">
                    ...
                    {icon === "safety" && (
                      ...
                      >
                        <path
                          d="M7 1l5 2v5c0 3-2.5 5-5 6C4.5 13 2 11 2 8V3z"
                          stroke="#999"
                          strokeWidth="1.2"
                        />
                        <path
                  ...
                  <div className="text-[0.82rem] font-semibold text-black">
                    {value}
                  </div>
                </div>
              ))}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[0.88rem] font-semibold text-black">
                  Mr. Mahmood
                </div>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path
                    d="M8 1l5 2v5c0 3.5-2.5 6-5 7C5.5 14 3 11.5 3 8V3z"
                    stroke="#2FA084"
                    strokeWidth="1.3"
                  />
                  <path
