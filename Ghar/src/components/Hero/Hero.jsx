    ...
    <section className="w-full bg-[#f5f5f3] px-20 pt-8 pb-0 overflow-hidden">
      <div className="flex items-start gap-12">
        ...
        <div className="flex flex-col gap-5 max-w-[550px] pb-10">
          ...
          {/* Subtitle */}
          <motion.p {...stagger(0.2)} className="text-[1rem] text-[#555] leading-relaxed max-w-[450px]">
            ...
            {["Near University", "Move in-Date", "Budget filter"].map((item, index) => (
              ...
              >
                ...
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none">
                  <path d="M1 1l6 6 6-6" stroke="#555" strokeWidth="1.4" strokeLinecap="round"/>
                </svg>
              </motion.button>
            ))}
          </div>

          {/* ── Social proof — fade added ── */}
          <motion.div {...stagger(0.7)} className="flex items-center gap-3">
            <div className="flex">
            ...
            <div>
              <div className="flex items-center gap-1 text-[0.82rem] font-semibold text-black">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="#F5A623">
                  <polygon points="7,1 8.8,5 13,5.5 10,8.4 10.8,12.6 7,10.5 3.2,12.6 4,8.4 1,5.5 5.2,5"/>
                </svg>
                4.8 &nbsp;•&nbsp; 2,300+ students
              </div>
        ...
        <div className="flex-1 relative flex items-start px-6 justify-end" style={{minHeight:'440px'}}>
          ...
          <div className="absolute top-10 left-115 z-40 af">
            <div className="flex items-center gap-2 bg-white rounded-2xl shadow-[2px_3px_8px_rgba(0,0,0,0.15)] px-3 py-2 text-[0.8rem] font-semibold text-black">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="#2FA084">
                <path d="M9 16s-7-4.5-7-9.5A4.5 4.5 0 019 3.5 4.5 4.5 0 0116 6.5C16 11.5 9 16 9 16z"/>
              </svg>
              Saved • 12 rooms
            </div>
          </div>
          ...
          <motion.div
            {...stagger(0.2)}
            className="w-full max-w-[400px] rounded-[28px] shadow-[0_20px_60px_rgba(0,0,0,0.2)] relative"
            style={{height:'600px'}}
          >
            ...
            <div className="absolute bottom-40 right-[-70px] z-40 af2">
              <div className="flex items-center gap-2 bg-black text-white rounded-2xl shadow-xl px-3 py-2 text-[0.78rem] font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6">
                  <path fill="#F5A623" d="M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z"/>
                  <path d="M9 12.75 11.25 15 15 9.75" fill="none" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Verified Landlords
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-[0.72rem] text-gray-400 mt-0.5">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                    <path d="M6 1C3.8 1 2 2.8 2 5c0 3 4 8 4 8s4-5 4-8c0-2.2-1.8-4-4-4z" stroke="#2FA084" strokeWidth="1.2"/>
                    <circle cx="6" cy="5" r="1.5" stroke="#2FA084" strokeWidth="1.2"/>
                  </svg>
                  6 min walk &nbsp;•&nbsp; LUMS
                </div>
              </div>
      ...
      <div className="container max-w-7.5xl">
        ...
        >
          {[
            { icon: CheckBadgeIcon, title: "Verified Listing",     body: "All things are verified for your safety." },
            { icon: AcademicCapIcon, title: "Near your University", body: "Find place close to your campus." },
            { icon: WalletIcon,      title: "Affordable Options",   body: "Filter by price and find what fits your budget." },
            { icon: UserIcon,        title: "Easy Contact",          body: "Connect direct with owners on WhatsApp." },
          ].map((f, i) => (
            <motion.div
              key={f.title}
              {...stagger(0.9 + i * 0.1)}
            ...
            >
              ...
              <div>
                <h3 className="text-[18px] font-semibold text-[#111] leading-tight">{f.title}</h3>
                <p className="mt-1 text-[14px] text-[#7A7A7A] leading-snug">{f.body}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
