...
const CARDS = [
  { id:1, name:'Students Inn',  location:'Gulshan Town,Lahore',       walk:'7 min walk to Uet Uni',  type:'Private Room', price:'Rs. 20,000', amenities:['Wifi','Meals','Kitchen','Laundary'], verified:true,  bgFrom:'#8B6914', bgTo:'#514c26' },
  { id:2, name:'Girls Hostel',  location:'North Nazimabad, Karachi',  walk:'7 min walk to Fast Uni', type:'Shared Room',  price:'Rs. 12,000', amenities:['Wifi','Meals','AC','S.Room'],        verified:true,  bgFrom:'#2d8a6a', bgTo:'#1a4a3a' },
  { id:3, name:'Prime Room',    location:'North Nazimabad, Karachi',  walk:'7 min walk to Fast Uni', type:'Entire Place', price:'Rs. 25,000', amenities:['Wifi','Meals','AC','Laundary'],        verified:false, bgFrom:'#4a3020', bgTo:'#2f1a1f' },
]
...
export default function Listings() {
  ...
  return (
    <section ref={ref} className="px-10 pt-10 pb-10 bg-white mt-8">
      {/* Header */}
